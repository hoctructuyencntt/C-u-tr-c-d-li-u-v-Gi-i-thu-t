...
var question1 = {
        question: "1. Cho nguyên mẫu hàm  int sum(int x, int y) tính tổng x và y. Trong hàm main, gọi sum với lệnh int s = sum(5, 4).  Chọn đáp án sai:",
        answers: ["a. x, y là tham số hình thức; 5, 4 là tham số thực",
"b. x, y là tham số thực; 5, 4 là tham số hình thức",
"c. Hàm sum truyền tham số kiểu tham trị",
"d. x, y là biến cục bộ"],
        correct: 1
    };

    var question2 = {
        question: "2. Cho nguyên mẫu hàm  int sum(int x, int y) tính tổng x và y. Trong hàm main, gọi sum với lệnh int s = sum(x, y).  Chọn đáp án đúng:",
        answers: ["a. x, y là tham số hình thức",
"b. x, y là tham số thực",
"c. x, y là biến toàn cục",
"d. x, y là biến cục bộ"],
        correct: 3
    };

    var question3 = {
        question: "3. Cho nguyên mẫu hàm  int sum(int *x, int *y) tính tổng hai số nguyên. Trong hàm main cho khai báo int x = 5; int y = 6. Gọi hàm sum trong main bằng lệnh nào sau đây:",
        answers: ["a. printf (“%d”,sum(\&x, \&y))",
"b. int s = sum(\&x, \&y)",
"c. int s = sum(*x, *y)",
"d. a hoặc b"],
        correct: 3
    ...
    function showResults() {
        ...
        if (correctAns == 3) {
            ...
            a.href = "https://hoctructuyencntt.com/2021/05/20/con-tro-pointer-bai-mo-dau/4/";

...
var question1 = {
        question: "1.  Với x là biến kiểu int, \&x có nghĩa là gì?",
        answers: ["a. Con trỏ x",
"b. Địa chỉ biến x",
"c. Một thao tác số học nào đó với biến x",
"d. a, b, c đều sai"],
        correct: 1
    };

    var question2 = {
        question: "2. Cho int x. Lệnh int*p = \&x có nghĩa là gì?",
        answers: ["a. Biến p chứa địa chỉ biến x",
"b. *p = x",
"c. Định nghĩa con trỏ p kiểu int",
"d. a, b, c đều đúng"],
        correct: 3
    };

    var question3 = {
        question: "3. Cho int x; int* p. Chọn đáp đúng nhất:",
        answers: ["a. p = \&x",
"b. *p = x",
"c. *p = \&x",
"d. a, b đúng"],
 ...
 var question4 = {
        question: "4. Khai báo int*p, q:",
        answers: ["a. p, q là con trỏ kiểu int",
"b. p là con trỏ kiểu int, q là biến kiểu int",
"c. p, q là biến kiểu int",
"d. a, b, c đều đúng"],
        correct: 1
    };

 var question5 = {
        question: "5. Khai báo int*p, *q:",
        answers: ["a. p, q là con trỏ kiểu int",
"b. p là con trỏ kiểu int, q là biến kiểu int",
"c. p, q là biến kiểu int",
"d. a, b, c đều đúng"],
    ...
    function showResults() {
        ...
        if (correctAns == 5) {
            ...
            a.href = "https://hoctructuyencntt.com/2021/05/20/con-tro-pointer-bai-mo-dau/";

...
var question1 = {
        question: "1. Khai báo int x; int* p = &x; char*q. Chọn đáp án đúng:",
        answers: ["a. p = (char*)q",
"b. (char*)p = q",
"c. q = int* p",
"d. a, b, c đều sai"],
    ...
    var question2 = {
        question: "2. Khai báo int x = 5; int* p = \&x; char*q =(char*)p. Giả sử \&x =200. Chọn đáp án sai:",
        answers: ["a. p = 200",
"b. p = q = 200",
"c. *p =*q = 5",
"d. p = q = 5"],
    ...
    var question3 = {
        question: "3. Khai báo int x = 5; int* p = \&x; char*q =(char*)p. Giả sử \&x =200. Chọn đáp án đúng:",
        answers: ["a. *p = 5, *q = 5",
"b. *p+1 = 6, *q+1 = 6",
"c. *(p+1) = 0, *(q+1) = 0",
"d. a, b, c đều đúng"],
 ...
 var question4 = {
        question: "4. Khai báo int x = 256; int* p = \&x; char*q =(char*)p. Giả sử \&x =200. Chọn đáp án sai:",
        answers: ["a. p = 200",
"b. p = q = 200",
"c. *p = *q = 256",
"d. *p = 256"],
 ...
 var question5 = {
        question: "5. Khai báo int x = 256; int* p = \&x; char*q =(char*)p. Giả sử \&x =200. Chọn đáp án đúng:",
        answers: ["a. *p =256, *q = 256",
"b. *p+1 = 257, *q+1 = 1",
"c. *(p+1) = 0, *(q+1) = 0",
"d. b, c đều đúng"],
        correct: 3
    ...
    function showResults() {
        ...
        if (correctAns == 5) {
            ...
            a.href = "https://hoctructuyencntt.com/2021/05/20/con-tro-pointer-bai-mo-dau/2/";
